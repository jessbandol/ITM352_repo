...
app.get("/login", function (request, response) {
    ...
    let username = request.query['username'] || ''; // Retrieve username from the query string
    let password = request.query['password'] || ''; // Retrieve password from the query string
    let error = request.query['error'] || ''; // Retrieve error message from the query string
    ...
    <div style="color: red; font-weight: bold;">${error}</div> <!-- Display error message -->
...
app.post("/login", function (request, response) {
    ...
    if (!errors) {
        ...
        // Redirect with error message and entered username
